    ...
    <div className="ps-lg-0">
        ...
        <div className="top-up-categories mb-30">
            ...
            <div className="main-content">
                <div className="row">
                    <Category price={18000500} icon="ic-desktop">Game <br/> Desktop</Category>
                    <Category price={8455000} icon="ic-mobile">Game <br/> Mobile</Category>
                    <Category price={5000000} icon="ic-desktop">Other <br/> Categories</Category>
                </div>
            </div>
        </div>
